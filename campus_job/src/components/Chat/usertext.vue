...
export default {
  ...
  methods: {
    addMessageByClick(){
      ...
      console.log('----------addMessageByClick---------');
      console.log(this.$store.state.currentUser);
      console.log('-----------------------');
    
        msgObj.from=this.$store.state.currentUser.sno
        msgObj.fromNickname=this.$store.state.currentUser.userName;
        msgObj.to=this.currentSession.sno;

        console.log('-------msgObj.photo--------');
        console.log(msgObj.photo);
